...
public class Main {
    ...
    public static void afegeixReservaBdd(Gestionador gestionador) {
        ...
        Reserva reserva1 = new Reserva("Alex", 1, gestionador.newData(24, 5, 2018), new Time(14, 30, 00));
        gestionador.creaReserva(reserva1, "pass");

        Reserva reserva2 = new Reserva("Marc", 4, gestionador.newData(26, 5, 2018), new Time(14, 30, 00));
        gestionador.creaReserva(reserva2, gestionador.generatePass());

        Reserva reserva3 = new Reserva("Paula", 3, gestionador.newData(29, 5, 2018), new Time(21, 30, 00));
        gestionador.creaReserva(reserva3, gestionador.generatePass());

        Reserva reserva4 = new Reserva("Manel", 4, gestionador.newData(28, 5, 2018), new Time(21, 30, 00));
        gestionador.creaReserva(reserva4, gestionador.generatePass());

        Reserva reserva5 = new Reserva("Alberto", 12, gestionador.newData(27, 5, 2018), new Time(14, 30, 00));
        gestionador.creaReserva(reserva5, gestionador.generatePass());

        Reserva reserva6 = new Reserva("Pol", 2, gestionador.newData(25, 5, 2018), new Time(13, 00, 00));
        gestionador.creaReserva(reserva6, gestionador.generatePass());

        Reserva reserva7 = new Reserva("Puigdemont", 1, gestionador.newData(24, 5, 2018), new Time(19, 30, 00));
        ...
        Reserva reserva9 = new Reserva("Samantha", 1, gestionador.newData(26, 5, 2018), new Time(13, 00, 00));
        gestionador.creaReserva(reserva9, gestionador.generatePass());

        Reserva reserva10 = new Reserva("Marialejandra", 3, gestionador.newData(28, 5, 2018), new Time(19, 30, 00));
        gestionador.creaReserva(reserva10, gestionador.generatePass());

        Reserva reserva11 = new Reserva("Guim", 6, gestionador.newData(28, 5, 2018), new Time(21, 30, 00));
